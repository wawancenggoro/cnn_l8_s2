...
class Net(nn.Module):
    ...
    def _initialize_weights(self):
        ...
        init.orthogonal_(self.layers_out_05[3].weight, init.calculate_gain('relu'))
        ...
        init.orthogonal_(self.layers_out_8A[3].weight, init.calculate_gain('relu'))
        init.orthogonal_(self.layers_out_09[3].weight)
        init.orthogonal_(self.layers_out_10[3].weight)
        init.orthogonal_(self.layers_out_11[3].weight, init.calculate_gain('relu'))
